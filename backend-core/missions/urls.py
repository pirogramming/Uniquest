...
urlpatterns = [
    ...
    path("api/chat/unread-count/", views.chat_unread_count, name="chat_unread_count"),
    path("api/chat/room/<int:room_id>/read/", views.chat_room_mark_read, name="chat_room_mark_read"),
